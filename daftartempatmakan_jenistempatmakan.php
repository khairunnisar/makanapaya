...
<tr></tr>
  <table width="100%" height="533" border="0" cellpadding="5" cellspacing="10">
    <tr>
      <td width="30%" height="31" bgcolor="#FFFFCC"><strong>  Cari Berdasarkan Kategori :</strong></td>
      <td width="70%" bgcolor="#FFFFCC"><strong>Daftar Tempat Makan [Jenis Tempat Makan: ]</strong></td>
    </tr>
    <tr>
      <td height="395" valign="top"><div id="conten">
        <table width="100%" height="296" border="0" cellpadding="5" cellspacing="7">
          <tr>
            <td width="136" height="10" valign="middle" nowrap="nowrap"><strong>
              <label for="harga">Harga </label>
            </strong></td>
            <td width="156" height="10" valign="middle">: 
          ...
          <tr>
            <td height="22" valign="middle"><strong>
          ...
          <tr>
            <td height="10" valign="middle"><strong>
          ...
          <tr>
            <td height="32" valign="middle"><strong>
