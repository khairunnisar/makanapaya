    ...
    <table width="1320" border="0" cellpadding="0" cellspacing="5">
      <tr>
        ...
        <td width="324"><strong>
          ...
          <a href="#">
          <input name="search" type="search" id="search5">
...
<tr></tr>
  <table width="100%" height="533" border="1" cellpadding="5" cellspacing="10">
    <tr>
      ...
      <td width="70%" bgcolor="#FFFFCC"><strong><a href="resto.php">AIOLA</a> | <a href="testimoni.php">TESTIMONI</a></strong></td>
    </tr>
    <tr>
      <td height="395" valign="top"><div id="conten">
        <table width="100%" height="296" border="1" cellpadding="5" cellspacing="7">
          <tr>
            <td width="136" height="10" align="left" valign="top" nowrap="nowrap"><strong>
              <label for="harga">Harga </label>
            </strong></td>
            <td width="156" height="10" align="left" valign="top">: 
          ...
          <tr>
            <td height="22" align="left" valign="top"><strong>
          ...
          <tr>
            <td height="10" align="left" valign="top"><strong>
          ...
          <tr>
            <td height="32" align="left" valign="top"><strong>
      ...
      <td valign="top"><p>Our Testimoni [ ]</p>
      <p>Rating : </p>
      <p><a href="#">Tambah Testimoni</a></p>      <p>&nbsp;</p></td>
    </tr>
  </table>
  <p>&nbsp;</p>
