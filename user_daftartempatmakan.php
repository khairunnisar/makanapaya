  ...
  <div id="navigasi">
    <table width="1320" border="0" cellpadding="0" cellspacing="5">
      <tr>
        ...
        <td width="297" bgcolor="#FFFF99"><div align="center"><strong><li id="current" <a href="daftartempatmakan.php">Daftar Tempat Makan</a></li></strong></div></td>
...
<tr></tr>
  <table width="100%" height="788" border="1" cellpadding="5" cellspacing="10">
    <tr>
      <td width="30%" height="31" bgcolor="#FFFFCC"><strong>  Cari Berdasarkan Kategori :</strong></td>
      <td width="70%" bgcolor="#FFFFCC"><strong>Daftar Tempat Makan :</strong></td>
    </tr>
    <tr>
      <td height="723" valign="top"><div id="conten">
        <table width="100%" height="289" border="1" cellpadding="5" cellspacing="7">
          <tr>
