...
<tr></tr>
  <div id="conten">
    <table width="1201" height="349" border="0" cellpadding="10" cellspacing="10">
    <tr>
      <td height="41" colspan="2" bgcolor="#FFFFCC"><strong>Cari Berdasarkan Kategori :</strong></td>
      <td width="838" bgcolor="#FCFBE0"><strong>Daftar Tempat Makan</strong></td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td height="42"><select name="jenismakanan" id="jenismakanan" title="jenis makanan">
    ...
    <tr>
      ...
      <td height="62"><select name="jenistempatmakan" id="jenistempatmakan" title="jenistempatmakan">
